...
可能大部分中国人都会支持这个提议，但不得不说在这个呼吁很尴尬。我们有什么权利要求Google“必须”继续蜻蜓计划？Google有什么义务必须要为中国服务？况且蜻蜓计划是做一个阉割版的Google，这就不得不妥协，甚至是违背Google“不作恶”的信条，是不是又会沦为某一集团的工具不得而知。

另一个问题是，做了阉割版之后，谁会用这个Google搜索呢，我肯定是不会用。事实上，作为一个中国人，如果你在乎你搜到的是什么东西，VPN的门槛并没有那么高，并不需要懂技术；如果你不在乎，阉割版Google进入大陆也无益处。

这个提议看起来真是又傻又天真。还不敢开评论。
